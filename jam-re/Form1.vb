...
Public Class Form1
    ...
    Function loadScripts(file As String) As Boolean
        ...
        Try
            ...
            Script = Microsoft.VisualBasic.Strings.Replace(Script, "%userdesktop%", Environment.GetFolderPath(System.Environment.SpecialFolder.DesktopDirectory), , , Constants.vbTextCompare)
            Script = Microsoft.VisualBasic.Strings.Replace(Script, "%userfavorites%", Environment.GetFolderPath(System.Environment.SpecialFolder.Favorites), , , Constants.vbTextCompare)
            Script = Microsoft.VisualBasic.Strings.Replace(Script, "%usercookies%", Environment.GetFolderPath(System.Environment.SpecialFolder.Cookies), , , Constants.vbTextCompare)
            Script = Microsoft.VisualBasic.Strings.Replace(Script, "%userhistory%", Environment.GetFolderPath(System.Environment.SpecialFolder.History), , , Constants.vbTextCompare)
            Script = Microsoft.VisualBasic.Strings.Replace(Script, "%userinternetcache%", Environment.GetFolderPath(System.Environment.SpecialFolder.InternetCache), , , Constants.vbTextCompare)
